...
const StudyHeaderInfo: React.FC<StudyHeaderInfoProps> = ({
  ...
  if (compact) {
    return (
      <div className="bg-gradient-to-r from-study-primary/10 to-study-accent/10 border border-study-primary/20 rounded-lg p-3">
          ...
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              <div className="text-sm text-muted-foreground">
                {format(examDate, "d 'de' MMMM", { locale: ptBR })}
              </div>
            </div>
          </div>
        ...
        {(currentSubject || nextSuggestion) && (
          <div className="mt-3 pt-3 border-t border-study-primary/20">
  ...
  return (
    <div className="bg-gradient-to-r from-study-primary/10 to-study-accent/10 border border-study-primary/20 rounded-lg p-4">
      ...
      <div className="flex items-center justify-between">
        ...
        {(currentSubject || nextSuggestion) && (
          <div className="flex items-center space-x-2">
            <Target className="h-4 w-4 text-study-accent" />
      ...
      {currentTopic && (
        <div className="mt-2 text-sm">
          ...
          <span className="font-medium text-study-primary ml-2">{currentTopic}</span>
          {currentSubtopic && (
            <span className="text-muted-foreground ml-2">• {currentSubtopic}</span>
          )}
        </div>
      )}
